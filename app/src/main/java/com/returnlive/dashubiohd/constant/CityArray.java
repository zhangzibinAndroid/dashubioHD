...
public class CityArray {
    ...
    //省级选项值
    public static String[] province = new String[]{"——选择省——", "北京市", "天津市", "河北省", "山西省", "内蒙古自治区", "辽宁省", "吉林省", "黑龙江省", "上海市", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西壮族自治区", "海南省", "重庆市", "四川省", "贵州省", "云南省",
    ...
    public static String[][] city = new String[][]
            {{"——选择市——"},
                    ...
                    {"乌鲁木齐市", "克拉玛依市", "吐鲁番市", "哈密地区", "昌吉回族自治州", "博尔塔拉蒙古自治州", "巴音郭楞蒙古自治州", "阿克苏地区", "克孜勒苏柯尔克孜自治州", "喀什地区", "和田地区", "伊犁哈萨克自治州", "塔城地区", "阿勒泰地区", "石河子市", "阿拉尔市", "图木舒克市", "五家渠市", "北屯市", "铁门关市", "双河市", "可克达拉市"},
                    {"台湾"},
    ...
    public static String[][][] county = new String[][][]
            {{{"——选择区——"}},
                    ...
                    {{"长安区", "桥西区", "新华区", "井陉矿区", "裕华区", "藁城区", "鹿泉区", "栾城区", "井陉县", "正定县", "行唐县", "灵寿县", "高邑县", "深泽县", "赞皇县", "无极县", "平山县", "元氏县", "赵县", "辛集市", "晋州市", "新乐市"},
                            ...
                            {"竞秀区", "莲池区", "满城区", "清苑区", "徐水区", "涞水县", "阜平县", "定兴县", "高阳县", "容城县", "涞源县", "望都县", "安新县", "易县", "曲阳县", "蠡县", "顺平县", "博野县", "雄县", "涿州市", "定州市", "安国市", "高碑店市"},
...
//以下数组未核对
                    ...
                    {{"锦江区", "青羊区", "金牛区", "武侯区", "成华区", "龙泉驿区", "青白江区", "新都区", "温江区", "双流区", "金堂县", "郫县", "大邑县", "蒲江县", "新津县", "都江堰市", "彭州市", "邛崃市", "崇州市"},
                            {"自流井区", "贡井区", "大安区", "沿滩区", "荣县", "富顺县"},
                            {"东区", "西区", "仁和区", "米易县", "盐边县"},
                            {"江阳区", "纳溪区", "龙马潭区", "合江县", "叙永县", "古蔺县", "泸县"},
                    ...
                    {{"城东区", "城中区", "城西区", "城北区", "大通回族土族自治县", "湟中县", "湟源县"},
                            ...
                            {"格尔木市", "德令哈市", "乌兰县", "都兰县", "天峻县", "海西蒙古族藏族自治州直辖"}},
